...
var current_display_type = "gamepanel"

var accent_color = Color(0.698039, 0.219608, 0.231373, 1)
var tab_inactive_color = Color(0.15, 0.15, 0.15, 1)

@onready var ap_label = $HBoxContainer/PanelBG/ContentMargin/MainVBox/HeaderRow/HeaderBox/APLabel
@onready var item_grid = $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/ItemColumn/ItemScroll/ItemGrid
@onready var item_header = $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/ItemColumn/ItemHeader
@onready var close_button = $HBoxContainer/CloseMargin/CloseButton
@onready var popup_layer = $PopupLayer
@onready var category_buttons = {
	"gamepanel": $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/CategoryColumn/CategoryScroll/CategoryList/SkillPanelButton,
	"portrait": $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/CategoryColumn/CategoryScroll/CategoryList/CharFrameButton,
	"character": $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/CategoryColumn/CategoryScroll/CategoryList/CharacterButton,
	"background": $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/CategoryColumn/CategoryScroll/CategoryList/BackgroundButton,
	"playercard": $HBoxContainer/PanelBG/ContentMargin/MainVBox/BodyContent/CategoryColumn/CategoryScroll/CategoryList/PlayerCardButton,
}

var category_display_names = {
	"gamepanel": "Action Panels",
	"portrait": "Character Frames",
...
func _update_category_visuals():
	for key in category_buttons:
		var btn: Button = category_buttons[key]
		var style = StyleBoxFlat.new()
		if key == current_display_type:
		...
		if key != current_display_type:
			hover.bg_color = Color(0.25, 0.18, 0.19, 1)
...
func show_buttons_by_type(cosmetic_type):
	...
	_update_category_visuals()
	if item_header:
		item_header.text = category_display_names.get(cosmetic_type, "Items")
...
func item_selected(price, unlock_name, display_name):
	...
	popup_layer.add_child(confirmation_panel)
...
func _on_texture_button_mouse_entered():
	close_button.modulate = Color(1.0, 1.0, 1.0, 0.51)
