...
func describe(user):
	...
	return "Passive: Whenever Luffy deals damage to an enemy, he will gain an equal amount of Shield for 1 turn."

func execute(user, battle):
	var context = QueryContext.from_game_state(user, battle)
	
	var trigger_desc = func (eff):
		return "Whenever Luffy deals damage to an enemy, he will gain an equal amount of Shield for 1 turn."
...
func rubber_body_trigger(context):
	var shield_eff = Effect.shield_effect(context['value'], 2)
