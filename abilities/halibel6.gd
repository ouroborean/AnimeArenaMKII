...
func describe(user):
	...
	return "Halibel unleashes a torrent of water, dealing " + str(base_damage + bonus) + " Energy damage to all enemies."

func split_desc():
	return [
		"Deals 20 Energy damage to all enemies.",
...
func custom_behavior(context):
	return behavior_hostile_aoe_damage(context, 0, 1.0)
