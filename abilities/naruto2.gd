...
func describe(user):
	...
	return "Deals 10 damage to one enemy for 2 turns and Shatters for 1 turn. On the second turn, the target is fully stunned. This deals 5 additional damage for every stack of Shadow Clones."

func split_desc():
	return ["Deals 40 damage to target enemy and stuns their non-Strategic skills for 1 turn"]
