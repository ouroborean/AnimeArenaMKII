...
func split_desc():
	return [
		...
		["Affected enemies take 10 Affliction damage each turn for the rest of the game", Color.ORANGE_RED]
	]
...
func execute(user, battle):
	...
	for target in user.targeter.targets:
		...
		var damage = Effect.damage_effect(10, DamageType.Type.AFFLICTION, -1)
