...
func describe(user):
	...
	return "Gatomon deals 20 damage to target enemy and paralyzes their cooldowns for 1 turn. Gatomon gains 1 stack of 'Digivolution'."

func split_desc():
	return [
		"Deals 20 damage to target enemy and Paralyzes their cooldowns for 1 turn",
...
func execute(user, battle):
	...
	for target in user.targeter.targets:
		...
		var paralyze = Effect.paralyze_effect(2)
